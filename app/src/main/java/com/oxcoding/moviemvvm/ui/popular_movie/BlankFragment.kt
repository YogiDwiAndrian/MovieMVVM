...
import com.oxcoding.moviemvvm.PopularFragmentPagedListAdapter
...
class BlankFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?){
        ...
        val movieAdapter = PopularFragmentPagedListAdapter(this)
        ...
        rv_movie_feagment.layoutManager = gridLayoutManager
        rv_movie_feagment.setHasFixedSize(true)
        rv_movie_feagment.adapter = movieAdapter
